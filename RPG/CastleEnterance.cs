...
namespace RPG
{
    class CastleEnterance : Actor
    {
        public CastleEnterance(float x, float y, char icon = ' ', ConsoleColor color = ConsoleColor.White) : base(x, y, icon, color)
        {
            _collisionRadius = 1;
        }

        public CastleEnterance(float x, float y, Color rayColor, char icon = ' ', ConsoleColor color = ConsoleColor.White) : base(x, y, rayColor, icon, color)
        {
            _collisionRadius = 1;
        }
        ...
        {
            Raylib.DrawCircle((int)(WorldPosition.X * 32), (int)(WorldPosition.Y * 32), _collisionRadius * 5, _rayColor);
